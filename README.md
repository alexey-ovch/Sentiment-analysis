...
Проект посвящен разработке модели классификации текстовых отзывов с использованием ансамблевого подхода. Задача заключается в определении принадлежности текстового отзыва к одному из двух классов на основе его содержимого.
